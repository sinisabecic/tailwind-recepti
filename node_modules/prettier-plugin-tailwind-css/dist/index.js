...
var prettierParserHTML = _interopDefault(require('prettier/parser-html'));
var prettierParserFlow = _interopDefault(require('prettier/parser-flow'));
var prettierParserTypescript = _interopDefault(require('prettier/parser-typescript'));
var prettierParserBabel = _interopDefault(require('prettier/parser-babel'));
...
function getParse(language, defaultParse) {
  return function (text, parsers, options) {
    ...
    if (fs.existsSync(options.classRegex) && fs.existsSync(options.classSorter)) {
      var classRegex = JSON.parse(fs.readFileSync(options.classRegex, 'utf8'));
      var classSorter = JSON.parse(fs.readFileSync(options.classSorter, 'utf8'));
...
var parsers = {
  html: _objectSpread2(_objectSpread2({}, prettierParserHTML.parsers.html), {}, {
    parse: getParse('html', prettierParserHTML.parsers.html.parse)
  }),
  flow: _objectSpread2(_objectSpread2({}, prettierParserFlow.parsers.flow), {}, {
    parse: getParse('javascriptreact', prettierParserFlow.parsers.flow.parse)
  }),
  typescript: _objectSpread2(_objectSpread2({}, prettierParserTypescript.parsers.typescript), {}, {
    parse: getParse('typescriptreact', prettierParserTypescript.parsers.typescript.parse)
  }),
  babel: _objectSpread2(_objectSpread2({}, prettierParserBabel.parsers.babel), {}, {
    parse: getParse('javascriptreact', prettierParserBabel.parsers.babel.parse)
  }),
  vue: _objectSpread2(_objectSpread2({}, prettierParserHTML.parsers.vue), {}, {
